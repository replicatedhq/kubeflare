...
import (
	...
	"github.com/replicatedhq/kubeflare/pkg/client/kubeflareclientset/scheme"
...
type CrdsV1alpha1Interface interface {
	...
	DNSRecordsGetter
	PageRulesGetter
	WebApplicationFirewallRulesGetter
	WorkerRoutesGetter
	ZonesGetter
}
...
func (c *CrdsV1alpha1Client) WorkerRoutes(namespace string) WorkerRouteInterface {
	return newWorkerRoutes(c, namespace)
}
