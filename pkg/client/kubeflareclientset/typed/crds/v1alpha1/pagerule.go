...
// PageRulesGetter has a method to return a PageRuleInterface.
...
// pageRules implements PageRuleInterface
type pageRules struct {
	client rest.Interface
	ns     string
}

// newPageRules returns a PageRules
func newPageRules(c *CrdsV1alpha1Client, namespace string) *pageRules {
	return &pageRules{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *pageRules) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.PageRule, err error) {
	result = &v1alpha1.PageRule{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("pagerules").
		Name(name).
...
func (c *pageRules) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.PageRuleList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.PageRuleList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("pagerules").
...
func (c *pageRules) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *pageRules) Create(ctx context.Context, pageRule *v1alpha1.PageRule, opts v1.CreateOptions) (result *v1alpha1.PageRule, err error) {
	result = &v1alpha1.PageRule{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("pagerules").
...
func (c *pageRules) Update(ctx context.Context, pageRule *v1alpha1.PageRule, opts v1.UpdateOptions) (result *v1alpha1.PageRule, err error) {
	result = &v1alpha1.PageRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pagerules").
...
func (c *pageRules) UpdateStatus(ctx context.Context, pageRule *v1alpha1.PageRule, opts v1.UpdateOptions) (result *v1alpha1.PageRule, err error) {
	result = &v1alpha1.PageRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pagerules").
...
func (c *pageRules) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *pageRules) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *pageRules) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.PageRule, err error) {
	result = &v1alpha1.PageRule{}
